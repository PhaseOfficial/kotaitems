    ...
    <>
      ...
      {showIcon && !visible && (
        <div
          ...
          className="fixed bottom-6 left-4 bg-orange-600 text-white p-3 rounded-full shadow-lg cursor-pointer hover:bg-orange-700 z-50 transition-all animate-bounce"
        ...
        <div className="fixed bottom-4 left-1/2 transform -translate-x-1/2 bg-gray-900 text-white p-4 rounded-lg shadow-lg w-[95%] max-w-md z-50 animate-fadeIn">
          ...
          <div className="flex justify-center gap-3">
            ...
            <button
              ...
              className="bg-orange-600 hover:bg-orange-700 text-white px-4 py-2 rounded-md text-sm transition"
            >
              Accept
            </button>
          </div>
